...
%scatter3(neurite_vector(:,1),neurite_vector(:,2),neurite_vector(:,3),'m'); 

p1 = mean(neurite_coords{1},1)
p2 = mean(neurite_coords{1},1) - std(neurite_coords{1},1)

scatter3(p1(:,1),p1(:,2),p1(:,3),500,'c')
