...
% Inputs:          nl      - standard neuron list
%               sigma      - distance in nm to be used as a bandwidth
%              n_dims      - number of demensions to consider 
%                dims      - which dimensions to consider (1 is ML, 2 is
%                            DV, 3 is AP
%             pre_post     - 1 for presynapses, 2 for post

if nargin == 5
elseif nargin == 4
    pre_post = input('Presynapses (1) / Postsynapses (2)')
else
